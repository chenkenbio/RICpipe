...
$prefix_read1_align=~s/.bam$//;
$prefix_read2_align=~s/.bam$//;
# keep basename for prefix
$prefix_read1_align=~s/.*\///;
$prefix_read2_align=~s/.*\///;
...
print "samtools view -@ $num_of_cpu -h -q 30 -F 256 -o $prefix_read1_align.uniq.sam $read1_align_sam\n";
print "samtools view -@ $num_of_cpu -h -q 30 -F 256 -o $prefix_read2_align.uniq.sam $read2_align_sam\n";

print "perl $dirs/scripts/obtain_pairs_from_pair.pl $prefix_read1_align.uniq.sam $prefix_read2_align.uniq.sam\n";
...
print "samtools sort -n -@ 10 -o interaction_from_pair_mapped_reads_1.sort.bam interaction_from_pair_mapped_reads_1.bam\n";
print "samtools sort -n -@ 10 -o interaction_from_pair_mapped_reads_2.sort.bam interaction_from_pair_mapped_reads_2.bam\n";
...
# keep basename for prefix
$prefix_read1_chimeric=~s/.*\///;
$prefix_read2_chimeric=~s/.*\///;
...
print "perl $dirs/scripts/obtain_pairs_from_gapped_reads.pl $prefix_read1_align.uniq.sam $prefix_read2_align.uniq.sam $prefix_read1_chimeric.processed.sam $prefix_read2_chimeric.processed.sam interaction_from_gapped_reads.sam \n";
